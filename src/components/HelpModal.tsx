...
export const HelpModal: React.FC<HelpModalProps> = ({ isOpen, onClose }) => {
  return (
    <UnifiedModal open={isOpen} onOpenChange={onClose}>
      <UnifiedModalContent className="max-w-4xl max-h-[90vh] p-0">
        <UnifiedModalHeader className="p-6 pb-0">
          <UnifiedModalTitle className="flex items-center gap-3 text-2xl">
        ...
        <div className="p-6 pt-0 border-t">
          <div className="flex justify-between items-center">
            ...
            <UnifiedButton onClick={onClose} variant="primary">
              Fermer
            </UnifiedButton>
          </div>
        </div>

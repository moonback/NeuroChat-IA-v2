...
export function ChatContainer({ 
  ...
  const [ragFilter] = useState<'all' | 'messages' | 'rag'>('all');
  // const [setRagFilter] = useState<'all' | 'messages' | 'rag'>('all'); // TODO: Implémenter l'UI pour changer le filtre RAG
...
import { 
  ...
  Sparkles, Bot, User, ChevronUp, ChevronDown,
  Database, Heart,
  Crown, Flame
} from 'lucide-react';

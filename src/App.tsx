...
function App() {
  ...
  useEffect(() => {
    const initializeSecurity = async () => {
      try {
        ...
        await initializePersistentEncryption();
  ...
  const { workspaceId, workspaces, wsKey } = useWorkspace();
  ...
  // --- Chiffrement persistant pour mode normal ---
  const [persistentEncryptionEnabled] = useState<boolean>(false);
    ...
    try {
      ...
      await streamMessage(
        ...
        prompt,
        {
          ...
          onDone: () => {
            // Comportement normal - pas de recherche web
